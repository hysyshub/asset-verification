...
function edToolbar(obj) {
    ...
    document.write("<br>");
    document.write("<img class=\"button\" src=\"editor/images/h1.gif\" name=\"btnH1\" title=\"H1\" onClick=\"doAddTags('<h1>','</h1>','" + obj + "')\">");
    document.write("<img class=\"button\" src=\"editor/images/h2.gif\" name=\"btnH2\" title=\"H2\" onClick=\"doAddTags('<h2>','</h2>','" + obj + "')\">");
    document.write("<img class=\"button\" src=\"editor/images/h3.gif\" name=\"btnH3\" title=\"H3\" onClick=\"doAddTags('<h3>','</h3>','" + obj + "')\">");
    document.write("<img class=\"button\" src=\"editor/images/h4.gif\" name=\"btnH4\" title=\"H4\" onClick=\"doAddTags('<h4>','</h4>','" + obj + "')\">");
    document.write("<img class=\"button\" src=\"editor/images/h5.gif\" name=\"btnH5\" title=\"H5\" onClick=\"doAddTags('<h5>','</h5>','" + obj + "')\">");
    document.write("<img class=\"button\" src=\"editor/images/h6.gif\" name=\"btnH6\" title=\"H6\" onClick=\"doAddTags('<h6>','</h6>','" + obj + "')\">");
    document.write("<img class=\"button\" src=\"editor/images/hr.gif\" name=\"btnHr\" title=\"Hr\" onClick=\"doAddTags('<hr/>','','" + obj + "')\">");
    document.write("<img class=\"button\" src=\"editor/images/br.gif\" name=\"btnBr\" title=\"Br\" onClick=\"doAddTags('<br/>','','" + obj + "')\">");
    document.write("<br>");
